...
// Replacing misspelled word
count = 0;
storyWords = storyWords.map(word => word === misspelledWord ? (count++, word = 'beautiful') : word);
console.log('\n' + count + ' words altered, fixing \'beautifull\'');
console.log(storyWords.join(' '));
...
console.log(`Is every word in this story less than 10 letters? ${lengthCheck}`)
